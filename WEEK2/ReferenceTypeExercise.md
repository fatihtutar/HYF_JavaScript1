...
```js
let arr_1 = [1,2,3]; // write this line
let arr_2 = [1,2,3]; // write this line
...
```js
let obj_1 = [1,3,5]; // write this line
let obj_2 = [1,3,5]; // write this line
